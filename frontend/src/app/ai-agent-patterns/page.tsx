...
export const metadata: Metadata = {
  title: "AI 에이전트 설계 패턴 5가지 | Lumos Lab",
  description: "Single-shot, ReAct, Planner-executor, Reflexive, Verifier-gated의 실행 흐름과 선택 기준을 비교합니다.",
};
...
export default function AiAgentPatternsPage() {
  return (
    <ReferencePage breadcrumb="레퍼런스 / AI 에이전트 패턴" label="실행 흐름 · 비용 · 검증" title="AI 에이전트 설계 패턴 5가지"
